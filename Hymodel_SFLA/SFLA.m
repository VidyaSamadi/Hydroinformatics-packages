...
m=5; %the number of memeplexes
n=4; %the number of frogs in a memeplex
q=3; %the number of frogs in a submemeplex
...
d=5; %the number of decision variables memotypes in a meme carried by a frog
Pmin =[1 0.1 0.1 0 0.1]; %the frogs' d-dimensions maximum position
Pmax =[500 2 0.99 0.1 0.99];%the frogs' d-dimensions minimum position
%generation number
MAXGEN=3;
