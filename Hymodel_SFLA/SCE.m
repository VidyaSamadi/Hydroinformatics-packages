clear;
clc
global BESTX BESTF ICALL PX PF ss PARSout NSout Smod Qobs num sst PARt NSt minpar95 maxpar95 mintot95 maxtot95
...
if ifunc==1;
    !copy NS.m NS.m
    bl=[1 0.1 0.1 0 0.1]; bu=[500 2 0.99 0.1 0.99]; x0=bl+(rand(1,5).*(bu-bl));
end;
